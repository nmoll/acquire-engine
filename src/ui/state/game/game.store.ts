...
export class GameStore {
    ...
    addPlayer(playerId: string) {
        ...
        this.gameLoadedState.value = {
            ...
            game: {
                ...
                playerIds: [
                    ...this.gameLoadedState.value.game.playerIds,
                    playerId
                ]
            }
        }
    ...
    onActionsChanged(gameId: string, callback: (actions: PlayerAction[]) => void) {
    ...
    private watchGame(gameId: string) {
        if (this.gameLoadedState.value.type !== 'loaded' || this.gameLoadedState.value.game.id !== gameId) {
            this.gameLoadedState.value = {
                type: 'loading'
            }
